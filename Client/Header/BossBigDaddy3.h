...
class CBossBigDaddy3 : public CMonster
{
	enum BIGDADDYSTATE { IDLE, ATTACK, DEAD, BIGDADDYSTATE_END };

private:
	explicit			CBossBigDaddy3(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit			CBossBigDaddy3(CMonster& rhs);
	virtual				~CBossBigDaddy3();
...
private:
	...
	_int				  m_iIndex = 0;
public:
	static CBossBigDaddy3* Create(LPDIRECT3DDEVICE9 pGraphicDev, _int iIndex);
