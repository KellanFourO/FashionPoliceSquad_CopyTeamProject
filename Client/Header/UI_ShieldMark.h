...
class CShieldMark : public Engine::CGameObject
{

private:
	explicit					 CShieldMark(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit					 CShieldMark(const CShieldMark& rhs);
	virtual						~CShieldMark();
...
public:
	static CShieldMark*			Create(LPDIRECT3DDEVICE9 pGraphicDev);
