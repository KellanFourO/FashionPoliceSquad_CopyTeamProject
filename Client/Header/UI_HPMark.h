...
class CHPMark : public Engine::CGameObject
{

private:
	explicit					 CHPMark(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit					 CHPMark(const CHPMark& rhs);
	virtual						~CHPMark();
...
public:
	static CHPMark*			Create(LPDIRECT3DDEVICE9 pGraphicDev);
