...
class CHPBarFrame : public Engine::CGameObject
{

private:
	explicit					 CHPBarFrame(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit					 CHPBarFrame(const CHPBarFrame& rhs);
	virtual						~CHPBarFrame();
...
public:
	static CHPBarFrame*			Create(LPDIRECT3DDEVICE9 pGraphicDev);
