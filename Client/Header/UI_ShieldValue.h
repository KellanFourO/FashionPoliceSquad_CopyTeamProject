...
class CShieldValue : public Engine::CGameObject
{

private:
	explicit					 CShieldValue(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit					 CShieldValue(const CShieldValue& rhs);
	virtual						~CShieldValue();
...
public:
	static CShieldValue*			Create(LPDIRECT3DDEVICE9 pGraphicDev);
