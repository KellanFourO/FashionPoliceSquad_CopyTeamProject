...
_uint CLoading::Loading_For_Stage()
{
	...
	Set_Value(3);
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_CrossTex", CCrossTex::Create(m_pGraphicDev)), E_FAIL);
	Set_Value(3);
...

	{
		...
		Set_Value(3);
		FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_KickBoardMonster", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/Resource/Texture/Monster/neonshirt-v1_Walk.png")), E_FAIL);
...

	{
		...
		FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_R_Bullet", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/Resource/Texture/Guns/Rifle_Bullet.png")), E_FAIL);
		Set_Value(3);
...
_uint CLoading::Loading_For_MapTool()
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_CrossTexture", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/Resource/Texture/Obj/CrossType/CrossType%d.png", 4)), E_FAIL);

	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_CrossTex", CCrossTex::Create(m_pGraphicDev)), E_FAIL);
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_CubeTexture", CTexture::Create(m_pGraphicDev, TEX_CUBE, L"../Bin/Resource/Texture/Obj/CubeType/Box_Full%d.dds", 3)), E_FAIL);
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_PlaneTexture", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/Resource/Texture/Obj/PlaneType/PlaneType_%d.png", 20)), E_FAIL);
