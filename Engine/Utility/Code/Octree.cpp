...
#include "Frustum.h"
#include "../../Client/Header/Build_Cube.h"
...
void COctree::Render_Octree(LPDIRECT3DDEVICE9 pGraphicDev)
{
   ...
   pGraphicDev->SetRenderState(D3DRS_ALPHABLENDENABLE, TRUE);*/
	...
	m_pOctreeRoot->Render_OctreeNode(pGraphicDev, true);
	//m_pOctreeRoot->CheckCullNode(m_pOctreeRoot);
}
...
_int COctree::IsInFrustum(COctreeNode* const pNode)
{
	_int    iSum = 0;
