...
namespace Engine
{
	...
	enum CHANNELID { SOUND_EFFECT, SOUND_EFFECT2, SOUND_EFFECT3, SOUND_BGM, SOUND_PLAYER, SOUND_PLAYER2, SOUND_PLAYER3, SOUND_GUN, SOUND_MONSTER, SOUND_MONSTER2, SOUND_BOSS, SOUND_BOSS2, SOUND_DIALOG, SOUND_DIALOG2, MAXCHANNEL };
	...
	enum class OBJ_ATTRIBUTE { DES_OBJ, INTER_OBJ, LIGHT_OBJ, BILL_OBJ, NONE_OBJ, TRIGGER_OBJ,
		C_POINT_OBJ, MOVING_OBJ, STAIR_OBJ, STD_OBJ, ForPaint_OBJ, FOG_OBJ, ATTRIBUTE_END };
	...
	enum class DIALOGTAG { STORY_ST1_INTRO, STORY_ST1_DEVELOP, STORY_ST1_CONCLU, STORY_LOBBY_INTRO, STORY_LOBBY_GAME1, STORY_LOBBY_GAME2, STORY_LOBBY_CONCLU, STORY_LOBBY_CONCLU2, ST1_BOSS_INTRO, ST1_BOSS_CONCLU, STORY_ST2_INTRO, STORY_ST2_CONCLU, SKILL_DASH, SKILL_ROPE, ENCOUNTER_DULLSUIT, ENCOUNTER_BIGDADDY, ENCOUNTER_KICKBOARD,QUIZ, DIALOGTAG_END};
