...
namespace Engine
{
	...
	enum class OBJ_ATTRIBUTE { DES_OBJ, INTER_OBJ, LIGHT_OBJ, BILL_OBJ, NONE_OBJ, TRIGGER_OBJ, C_POINT_OBJ, MOVING_OBJ, STAIR_OBJ, STD_OBJ, ATTRIBUTE_END };
							//파괴OBJ, 상호작용OBJ, 조명OBJ, 빌보드 OBJ, 장식 OBJ, 트리거 OBJ, CreatePoint, 무빙 OBJ , 계단용 OBJ, (1회용)시야 설정목적
