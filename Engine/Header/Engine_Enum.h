...
namespace Engine
{
	...
	enum class DIALOGTAG { STORY_ST1_INTRO, STORY_ST1_DEVELOP, STORY_ST1_CONCLU, STORY_LOBBY_INTRO, STORY_LOBBY_GAME1, STORY_LOBBY_GAME2, STORY_LOBBY_CONCLU, ST1_BOSS_INTRO, ST1_BOSS_CONCLU, STORY_ST2_INTRO, STORY_ST2_CONCLU, DIALOGTAG_END};
