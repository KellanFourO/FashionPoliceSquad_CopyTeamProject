...
namespace Engine
{
	...
	{
		PLAYER, PROGRESSVALUE, PROGRESSFRAME, FPSCAMERA, DCAMERA, PLAYERBULLET,  MONSTER, BOSS, ITEM, MONSTERBULLET, UI,
		MISSION, PORTRAIT, CROSSHAIR, CARDLIST, CARD, CARDTEXTURE, DIALOG, BOSSBULLET, OBJECT, RAY, SKYBOX,  EFFECT, BACKGOUND,  WIREFRAME,
		DYEHARD, BUILD_CUBE, BUILD_OBJ, PLAYER_GUN, MAPCURSOR, DEAD_OBJ, DEAD_MONSTER, PARTICLE, OBJECT_END
	};
	...
	enum class OBJ_TYPE { BUILDING, CUBE_OBJ, PLANE_OBJ, OBJ_TYPE_END };
						//빌딩용  , 큐브OBJ,  평면OBJ
	enum class OBJ_ATTRIBUTE { DES_OBJ, INTER_OBJ, LIGHT_OBJ, NONE_OBJ, ATTRIBUTE_END };
							//파괴OBJ, 상호작용OBJ,  조명OBJ, 장식 OBJ
