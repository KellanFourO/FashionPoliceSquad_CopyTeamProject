...
namespace Engine
{
	...
	enum CHANNELID { SOUND_EFFECT, SOUND_BGM, SOUND_PLAYER, SOUND_PLAYER2, SOUND_GUN, SOUND_MONSTER, MAXCHANNEL };
												//todo 플레이어가 두개인 이유는 두개가 동시에 필요한경우가 있어서
	...
	enum class OBJ_ATTRIBUTE { DES_OBJ, INTER_OBJ, LIGHT_OBJ, BILL_OBJ, NONE_OBJ, TRIGGER_OBJ,
		C_POINT_OBJ, MOVING_OBJ, STAIR_OBJ, STD_OBJ, ForPaint_OBJ, ATTRIBUTE_END };
							//파괴OBJ, 상호작용OBJ, 조명OBJ, 빌보드 OBJ, 장식 OBJ, 트리거 OBJ,
		//CreatePoint, 무빙 OBJ , 계단용 OBJ, STD OBJ, 페인트용
