...
namespace Engine
{
	...
	enum class OBJECTTAG
	{
		...
		DYEHARD, PLAYER_LAZER, PLAYER_GUN, PLAYER_HAND, BUILD_CUBE, BUILD_OBJ, MAPCURSOR, DEAD_OBJ, DEAD_MONSTER, PARTICLE, OBJECT_END
	};
	...
	enum class TRIGGER_TYPE { TR_MOVING, TR_DLG, TR_CARD, TR_UI, TR_DAMAGE, TR_MONSTER, TR_EVENT, TR_NOTHING, TR_TYPE_END };
