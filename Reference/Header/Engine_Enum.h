...
namespace Engine
{
	...
	enum class MINIGAME_OBJ { MINI_PLAYER, MINI_ENEMY, MINI_ARROW, MINI_CURSOR, MINI_TIMER, MINI_GOLD, MINIGAME_END };
	...
	enum class PORTRAITTAG {PORT_DES, PORT_DESNEON, PORT_HALEY, PORT_DEEPCOAT, PORT_BAUSS, PORT_TURNCOAT, PORT_DESDULL, PORT_MYSTERY, PORT_PHONE};
