...
namespace Engine
{
	...
	enum COMPONENTID { ID_DYNAMIC, ID_STATIC, ID_END=2 };
	...
	{
		PLAYER, PROGRESSVALUE, PROGRESSFRAME, FPSCAMERA, DCAMERA, FLYCAMERA,  MONSTER, PLAYERBULLET, BOSS, ITEM, MONSTERBULLET, UI,
		...
		DYEHARD, PLAYER_GUN, PLAYER_HAND, PLAYER_LAZER, BUILD_CUBE, BUILD_OBJ, MAPCURSOR, DEAD_OBJ, DEAD_MONSTER, PARTICLE, OBJECT_END
	};
